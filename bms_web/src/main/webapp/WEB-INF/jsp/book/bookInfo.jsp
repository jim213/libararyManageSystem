...
<form id="bookForm" action="${pageContext.request.contextPath 
	...
	<table width="100%" border=1>
		<tr>
			<td>书名</td>
			<td><input type="text" name="bookName" value="${bookPo.bookName }" /></td>
		</tr>
		<tr>
			<td>图书分类</td>
...
<a href="${pageContext.request.contextPath }/books/deleteBook.action?book.book_ISBN=${book.bookISBN}">将本书下架</a>
</body>
</html>